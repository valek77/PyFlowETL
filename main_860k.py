...
validation_rules = {
    "MAIL": [NotEmptyValidator(), ColumnComparisonValidator("!=", "all@gmail.com"), RegexValidator(pattern=r"^(?!\d+@gmail\.com$).+")],
...
pipeline.extract(CsvExtractor(f"C:\\Users\\marco\\Downloads\\MAIL\\860K_MAIL.csv", delimiter=";", low_memory=False))
...
pipeline.transform(ValidateColumnsTransformer(
    ...
    reject_output_path=f"C:\\Users\\marco\\Downloads\\MAIL\\SCARTI_860K_MAIL.csv"
))
...
pipeline.load(CsvLoader("C:\\Users\\marco\\Downloads\\MAIL\\860K_MAIL_OUT.csv", delimiter=";"))
