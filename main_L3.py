...
pipeline.extract(CsvExtractor(f"/Users/marco/tmp/L3.csv", delimiter=";", low_memory=False))
...
pipeline.transform(ValidateColumnsTransformer(
    ...
    reject_output_path=f"/Users/marco/tmp/SCARTI_L3.csv"
))
...
pipeline.load(CsvLoader("/Users/marco/tmp/L3_OUT.txt", delimiter=";"))
