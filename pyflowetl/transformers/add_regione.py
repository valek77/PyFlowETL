...
class AddRegioneTransformer:
    def __init__(self, comune_column: str, output_column: str = "REGIONE"):
        ...
        self.comuni_map = self.comuni_df.set_index("METAPHONE")["denominazione_regione"].to_dict()
        logger.info(f"[AddRegioneTransformer] Mapping '{self.comune_column}' to '{self.output_column}'")
